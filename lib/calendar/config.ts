...
export function getGoogleCalendarConfig(appUrlOverride?: string): GoogleCalendarConfig | null {
  ...
  const appUrl = (appUrlOverride || process.env["NEXT_PUBLIC_APP_URL"])?.replace(/\/$/, "");
