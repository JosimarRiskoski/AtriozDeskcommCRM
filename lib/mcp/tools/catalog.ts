...
export const TOOL_CATALOG: ReadonlyArray<McpToolCatalogEntry> = [
  ...
  { name: "crm_get_contact", category: "read", description: "Detalhe de um contato" },
  {
    ...
    category: "read",
    description: "Lista conversas (com assignee_kind, assigned_to_user_name, tags, queue_position)",
  },
  {
  ...
  { name: "crm_create_lead", category: "write", description: "Cria um lead" },
  {
    ...
    category: "write",
    description: "Atualiza dados comerciais confirmados de um contato",
  },
  {
    name: "crm_add_contact_note",
    category: "write",
    description: "Registra observação confirmada na timeline do contato",
  },
