...
export type AuditAction =
  ...
  | "message.sent"
  | "message.received"
  | "message.identity_pending"
  | "message.identity_reconciled"
  | "contact.blocked"
  | "ai.handoff_triggered"
  | "human_case.created"
  | "human_case.assigned"
  | "human_case.transferred"
  | "human_support.settings_changed"
  | "human_support.group_test_sent"
  | "human_support.group_command_rejected"
  | "human_support.group_command_executed"
  ...
  | "ai_agent.tested"
  | "ai_agent.reverted"
  | "ai_agent.legacy_upgraded"
  | "ai_agent.default_changed"
  | "ai.dispatcher_run"
  ...
  | "channel.restored"
  | "channel.deleted"
  | "whatsapp.inbound_recovery_run"
  | "authz.denied"
  | "team.role_changed"
  | "team.human_case_eligibility_changed"
  | "leads.bulk_assigned"
  ...
  | "followup_enrollment.bulk_created"
