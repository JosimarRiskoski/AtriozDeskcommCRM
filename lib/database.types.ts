    ...
    Tables: {
      ...
      whatsapp_inbound_pending: {
        Row: {
          ...
          reconciled_contact_id: string | null;
          reconciled_conversation_id: string | null;
          status: string;
          updated_at: string;
        };
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_inbound_pending_channel_session_id_fkey";
            columns: ["channel_session_id"];
            isOneToOne: false;
            referencedRelation: "channel_sessions";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "whatsapp_inbound_pending_organization_id_fkey";
            columns: ["organization_id"];
            isOneToOne: false;
            referencedRelation: "organizations";
            referencedColumns: ["id"];
      ...
      human_support_settings: {
        Row: {
          allow_group_replies: boolean;
          authorized_manager_phones: string[];
          business_hours: Json;
          close_alert_on_resolution: boolean;
          created_at: string;
          escalation_minutes: number;
          first_alert_minutes: number;
          group_message_template: string;
          group_phone_display: string;
          group_notify_ai_budget: boolean;
          group_notify_campaign_paused: boolean;
          group_notify_connection_down: boolean;
          group_notify_crm_errors: boolean;
          group_notify_handoffs: boolean;
          handoff_rules: Json;
          notify_email: boolean;
          notify_in_app: boolean;
          notify_whatsapp_group: boolean;
          organization_id: string;
          max_alert_repeats: number;
        ...
        Relationships: [
          {
            foreignKeyName: "human_support_settings_organization_id_fkey";
            columns: ["organization_id"];
            isOneToOne: true;
            referencedRelation: "organizations";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "human_support_settings_whatsapp_connection_id_fkey";
      ...
      webhook_sources: {
        Row: {
          ...
          pilot_approved_by_user_id: string | null;
          ...
          token_overlap_until: string | null;
          updated_at: string;
        };
        Insert: {
          created_at?: string;
